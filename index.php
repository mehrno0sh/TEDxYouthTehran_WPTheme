<?php get_header(); ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-sm-12"><img id="intro-image"
                                                                         ...
                                                                         alt="intro" src="<?php bloginfo('template_directory'); ?>/images/intro-p.svg"></div>
                </div>
                <div class="row">
    ...
    <section id="talks" class="main style3 primary">
        <div class="content">
            <header>
                <h2>2013 Talks</h2>
                <p>Lorem ipsum dolor sit amet et sapien sed elementum egestas dolore condimentum. Fusce blandit ultrices
                    sapien, in accumsan orci rhoncus eu. Sed sodales venenatis arcu, id varius justo euismod in.
                    Curabitur egestas consectetur magna vitae.</p>
            </header>
            <!-- Gallery  -->
            <div class="gallery">
                <article class="from-left">
                    <a target="_blank" href="https://youtu.be/QWAlzKsrW7I?list=PLSatVjzQd2dTUDCQ9sZZdvlAwgSPXDZ_b"
                       class="image fit">
                        <img src="<?php bloginfo('template_directory'); ?>/images/thumbs/01.jpg" title="Story of My Life" alt="Amirali Nabavian"/>
                        <div class="col-md-6 col-sm-5 col-xs-5">
                            <h3>Story of My Life</h3>
                        </div>
                        <div class="col-md-6 col-sm-5 col-xs-5">
                            <a class="aparat" href="http://aparat.com" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/aparat.png"></a>
                        </div>
                    </a>
                </article>
                <article class="from-right">
                    <a target="_blank" href="https://youtu.be/pghM2YGiFV8?list=PLSatVjzQd2dTUDCQ9sZZdvlAwgSPXDZ_b"
                       class="image fit">
                        <img src="<?php bloginfo('template_directory'); ?>/images/thumbs/02.jpg" title="Nurture Your Passion" alt="Alireza Eskandari"/>
                        <div class="col-md-6 col-sm-5 col-xs-5">
                ...
                <article class="from-left">
                    <a target="_blank" href="https://youtu.be/fPkM10XFb0c?list=PLSatVjzQd2dTUDCQ9sZZdvlAwgSPXDZ_b"
                       class="image fit">
                        <img src="<?php bloginfo('template_directory'); ?>/images/thumbs/03.jpg" title="7 Do's and Don'ts for Successful Entrepreneurship"
                             alt="Mohsen Malayeri"/>
                        <div class="col-md-6 col-sm-5 col-xs-5">
                ...
                <article class="from-right">
                    <a target="_blank" href="https://youtu.be/7zf-gLbZ0UE?list=PLSatVjzQd2dTUDCQ9sZZdvlAwgSPXDZ_b"
                       class="image fit">
                        <img src="<?php bloginfo('template_directory'); ?>/images/thumbs/04.jpg" title="How to Invent Your Career" alt="Reza BahramiNezhad"/>
                        <div class="col-md-6 col-sm-5 col-xs-5">
                ...
                <article class="from-left">
                    <a target="_blank" href="https://youtu.be/OF8m6EZIbdY?list=PLSatVjzQd2dTUDCQ9sZZdvlAwgSPXDZ_b"
                       class="image fit">
                        <img src="<?php bloginfo('template_directory'); ?>/images/thumbs/05.jpg" title="Me, Towards the Sun" alt="Nabila Ayoubi"/>
                        <div class="col-md-6 col-sm-5 col-xs-5">
